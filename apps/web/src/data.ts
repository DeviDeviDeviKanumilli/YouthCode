...
export function buildAnalystAnswer(
  ...
  return {
    summary: `In May 2025, the Delaware River Basin shows several notable ecological signals. ${topRow.commonName} is the top visible possible species by Ecological Signal Priority, while ${needsVerification} records still need verification before stronger claims are appropriate.`,
    findings: [
      {
